...
class Application @Inject()(override implicit val env: MyEnvironment[DemoUser],
                                  implicit override val messagesApi: MessagesApi, implicit val webJarAssets: WebJarAssets)
  extends securesocial.core.SecureSocial[DemoUser] with I18nSupport {
//class Application @Inject() (override implicit val env: MyEnvironment, webJarAssets: WebJarAssets) extends securesocial.core.SecureSocial  {
